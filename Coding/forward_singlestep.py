...
doubly_convolved_matrix, cache2 = single_convolution_layer_from_matrix(singly_maxxed_matrix, filter_size=(3, 3), stride=1, num_filters=64, padding=0)
doubly_maxxed_matrix = max_pool(doubly_convolved_matrix, size=(2, 2), stride=2)
triply_convolved_matrix, cache3 = single_convolution_layer_from_matrix(doubly_convolved_matrix, filter_size=(3, 3), stride=1, num_filters=128, padding=0)
